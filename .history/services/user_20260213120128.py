...
class UserService:
    ...
    def create_user(user_data: UserBase):
        ...
        # This object currently only exists in "RAM" inside this function
        new_user = User(
            id=new_id,
            **user_data.model_dump() # Unpacks name, email, role, etc.
        )
        
        # 3. SAVE IT TO THE DATABASE (The step you were asking about!)
        # This writes it to the global dictionary.
