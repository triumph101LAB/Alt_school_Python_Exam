...
class EnrollmentService:
    ...
    def get_all_enrollment(enrollments, current_user:User):
        ...
        return enrollments
    @staticmethod
    def get_course_enrollment(enrollment, course_id,user_id): 
        for enrollment in enrollments.values():
           if (enrollment.course_id == course_id and enrollment.user_id == user_id)
    @staticmethod
    def student_enrollment(student_id,enrollment_id):        